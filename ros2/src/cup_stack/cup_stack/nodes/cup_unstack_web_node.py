"""Web-triggered cup unstack using pixel coordinates from the dashboard."""
...
def main(args=None):
    ...
    try:
        ...
        runtime = CupStackRuntime(node, "cup_unstack_web_moveit_py")
        ...
        node.get_logger().info(
            ...
            f"base({pyramid_x:.3f},{pyramid_y:.3f})"
        )
